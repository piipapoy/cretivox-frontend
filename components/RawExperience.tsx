    ...
    <main className="dossier" ref={container}>
      ...
      <section className="dossier-hero" aria-label="Arap Cretivox intro">
        ...
        <svg className="signature-stage" viewBox="0 0 504 214" aria-hidden="true">
          <path className="signature-path" d="M58 152C26 183 9 146 47 119C91 88 158 70 222 53C276 39 324 37 322 52C320 69 272 88 225 103C203 110 203 118 230 117C269 116 322 101 358 86" />
          <path className="signature-path" d="M151 176C181 139 209 99 239 64C262 37 266 51 243 87C223 119 207 143 202 157C197 171 208 164 224 147C250 118 281 97 306 91C321 88 323 98 309 111C291 127 253 141 238 150C260 149 318 126 368 95" />
          <path className="signature-path" d="M405 35C399 81 392 119 378 157C373 170 364 166 369 149C381 112 410 83 441 72C459 66 465 75 449 88C429 104 389 111 354 111M379 61L427 43" />
        </svg>
      </section>
